...
-- Display category Id, category name for all categories and sort the result 
-- according to category name.
...
-- Display product Id, name, old and new prices. Sort the result according to 
-- first the category_id and then the product name descendingly.
select product_id, category_id, product_name, list_price as "Old Price", list_price * 1.02 as "New Price"
from products
...
-- does not retuen any values
select *
from products
where list_price <  200 and list_price > 3000
order by list_price;

-- How many rows the following query returns?
select *
from products
where list_price >  200 and list_price < 3000
order by list_price;
...
select *
from products
where list_price between 200 and 3000 -- 200 and 3000 are included
order by list_price;
...
select *
from products
where list_price not between 200 and 3000 -- 200 and 3000 are not included
order by list_price;
...
-- = ,<>, >=, <=, <, >
-- What is the category ID for CPU
select *
from product_categories
...
select *
from product_categories
where category_name  like 'CPU';

select *
from product_categories
where category_name  like 'C%'; -- % means anything or nothing
...
select *
from product_categories
where category_name  like '%r_';

select *
from product_categories
where category_name  like '_i%d';
...
-- grade in ('A', 'B', 'C', 'D')
-- grade = 'A' or grade = 'B' or grade = 'C' or grade = 'D' 

-- grade not in ('A', 'B', 'C', 'D')
-- grade <> 'A' and grade <> 'B' and grade <> 'C' and grade <> 'D' 
...
select product_id, category_id
from products
where category_id not in (2,4,5);
